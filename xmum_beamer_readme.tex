...
\begin{frame}{接口说明（二）}
    \begin{table}
        ...
        \begin{tabular}{p{0.45\linewidth}p{0.45\linewidth}}
            ...
            \texttt{\textbackslash XMUMSingleLineFrame\{title\}\{text\}} & 生成单行正文页（帧标题与正文均需显式传入） \\
            \bottomrule
        \end{tabular}
    \end{table}
\end{frame}
...
\begin{frame}{常用文稿结构}
    \begin{enumerate}
        ...
        \item 可使用 \texttt{\textbackslash XMUMSingleLineFrame\{帧标题\}\{单行文本\}} 来生成单行正文页。
    \end{enumerate}
...
\XMUMSingleLineFrame{感谢}{感谢阅读和使用此模板}
